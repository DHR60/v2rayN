...
public class OptionSettingViewModel : MyReactiveObject
{
    ...
    [Reactive] public string TestResultDivisor { get; set; }
    ...
    [Reactive] public bool TunEnableExDirectPorts { get; set; }
    ...
    private async Task Init()
    {
        ...
        TestResultDivisor = _config.SpeedTestItem.TestResultDivisor;
        ...
        TunEnableExDirectPorts = _config.TunModeItem.EnableExDirectPorts;
    ...
    private async Task SaveSettingAsync()
    {
        ...
        _config.SpeedTestItem.TestResultDivisor = TestResultDivisor;
        ...
        _config.TunModeItem.EnableExDirectPorts = TunEnableExDirectPorts;
