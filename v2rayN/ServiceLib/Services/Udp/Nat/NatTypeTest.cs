using static ServiceLib.Services.Udp.Socks5UdpChannel;

namespace ServiceLib.Services.Udp.Nat;
...
public class NatTypeTest
{
    ...
    public StunResult Result { get; private set; } = new StunResult
    {
    ...
    private async Task RunFilteringTestAsync(Socks5UdpChannel channel, CancellationToken cancellationToken)
    {
        ...
        Socks5RemoteEndpoint? remoteEndpoint1 = null;
        ...
        Socks5RemoteEndpoint? remoteEndpoint2 = null;
    ...
    private static async Task<(Socks5RemoteEndpoint Remote, byte[] Data)> ReceiveWithTimeoutAsync(
