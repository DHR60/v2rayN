...
public partial class OptionSettingWindow
{
    ...
    public OptionSettingWindow()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, vm => vm.TestResultDivisor, v => v.txtTestResultDivisor.Text).DisposeWith(disposables);
            ...
            this.Bind(ViewModel, vm => vm.TunEnableExDirectPorts, v => v.togEnableExDirectPorts.IsChecked).DisposeWith(disposables);
